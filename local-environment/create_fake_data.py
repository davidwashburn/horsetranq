#!/usr/bin/env python3
"""
Fake Data Generator for Horsetranq Database
This script creates realistic fake data for testing the new database system.
"""
...
def create_fake_data():
    """Create comprehensive fake data for testing."""
    
    base_url = "https://horsetranq.com"
    
    print("🎭 Creating Fake Data for Horsetranq...")
    print("=" * 50)
    ...
    try:
        ...
        for i, user_data in enumerate(fake_users):
            ...
            # Simulate user creation (since we can't actually create users without auth)
            # We'll create the data directly in the database structure
            ...
            for session_num in range(num_sessions):
                ...
                try:
                    ...
                    if response.status_code == 200:
                        ...
                        response = requests.post(f"{base_url}/api/game/finish",
                                              json={"session_id": session_id, **final_data}, timeout=10)
                        
                        if response.status_code == 200:
                            total_sessions += 1
                        else:
                            print(f"   ⚠️  Failed to finish session: {response.status_code}")
                    else:
        ...
        print(f"   ✅ Created {total_sessions} game sessions")
            ...
            print("\n3. Creating fake scoreboard entries...")
    
    # Create some high scores for the scoreboard
        for user in created_users:
        ...
        print("   3. Try logging in with one of the test accounts")
...
if __name__ == "__main__":
    print("Horsetranq Fake Data Generator")
    print("=" * 40)
    print("⚠️  This will create fake users and game data for testing.")
    print()
